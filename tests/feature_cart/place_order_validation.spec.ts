...
test.describe('@feature_cart Place Order Validation', () => {
  ...
  test('@QAAGENT-61 Verify that User can place an order', async () => {
    ...
    // Step 1: Navigate to homepage is handled in beforeEach
    ...
    // Step 11: Verify "Thank you for your purchase" message
    await cartPage.verifyPurchaseMessage('Thank you for your purchase!');
  });
});