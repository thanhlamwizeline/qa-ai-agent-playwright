...
test.describe('@feature_homepage Product Display Verification', () => {
  ...
  test('@QAAGENT-44 Navigate to home page and verify product container and Samsung galaxy s6 product display', async () => {
    ...
    await homePage.verifyProductTableBodyIsVisible();
